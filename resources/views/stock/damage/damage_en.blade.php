    ...
    <main
        ...
        <section style="width: 100%;">
            ...
            <article style="width: 33%; float: left; text-align: center;">
                <p style="font-size: 1.4rem; color: #445164;">Damage Stock Report</p>
            </article>
        ...
        <section style="margin-top: 1.6rem;">
            <p style="font-size: 1.2rem; color: #445164; margin-bottom: .4rem;">Damage Product list (02)</p>

            <table style="width: 100%; padding: 0; border:none;">
                <tHead>
                    <tr>
                        <th style="width: 13rem;">product name</th>
                        <th style="width:8rem;">Damage Stock QTY</th>
                        <th style="width:7rem;">total price</th>
                        <th style="width:8rem;">remarks</th>
                    </tr>
                </tHead>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td
                            style="width:8rem; border-right: none; border-left: none; border-bottom-color: black; font-weight: 600;">
                            100
                        </td>
                        <td
                        ...
                        <td style="width: 8rem; border: none;"></td>
                    </tr>
                </tfoot>
            </table>
