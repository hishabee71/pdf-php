    ...
    <main
        ...
        <section style="width: 100%;">
            ...
            <article style="width: 33%; float: left; text-align: center;">
                <p style="font-size: 1.4rem; color: #445164;">Stock Transaction Report</p>
                <p style="font-size: 1rem; color: #445164;">12 August 2023</p>
            </article>
        ...
        <section style="margin-top: 1.6rem;">
            <p style="font-size: 1.2rem; color: #445164; margin-bottom: .4rem;">Transaction list (03)</p>

            <table style="width: 100%; padding: 0; border:none;">
                <tHead>
                    <tr>
                        <th style="width: 10rem;">trans Date</th>
                        <th style="width:6.6rem;">CHALLAN NO</th>
                        <th style="width:6.6rem;">Tran. type</th>
                        <th style="width:10rem;">Product name</th>
                        <th style="width:8.5rem;">party name</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width:6.6rem;">Stock in</td>
