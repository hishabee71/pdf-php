    ...
    <main
        ...
        <section style="width: 100%;">
            ...
            <article style="width: 33%; float: left; text-align: center;">
                <p style="font-size: 1.4rem; color: #445164;">রিসিপ্ট</p>
            </article>
        ...
        <section style="margin-top: 1.6rem;">
            ...
            <table style="width: 100%; padding: 0; border:none;">
                <tHead>
                    <tr>
                        <th style="width: 12rem;">পণ্যের নাম</th>
                        <th style="width:4rem;">পরিমান</th>
                        <th style="width:6.5rem;">দর</th>
                        <th style="width:4rem;">রিটার্ন </th>
                        <th style="width:6.5rem;">বিক্রয় </th>
                        <th style="width:4rem;">ফ্রি</th>
                        <th style="width:8rem;">মোট টাকা</th>
                    </tr>
                </tHead>
            ...
            <article
                ...
                <p>
                    <b style="display: inline-block;">মোট পরিমান</b>
                ...
                <p style="padding: 1rem 0; border-bottom: 1px dashed #D1D1D1; margin-bottom: 1rem;">
                    <b style="display: inline-block;">পরিশোধ পরিমান</b>
                    <span style="display: inline-block; min-width: 5rem; ">৳ 15,000</span>
                </p>
                <p>
                    <b style="display: inline-block;">বাকী</b>
                    <span style="display: inline-block; min-width: 5rem;">৳ 18,000</span>
                </p>
