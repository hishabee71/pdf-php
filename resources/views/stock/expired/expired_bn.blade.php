    ...
    <main
        ...
        <section style="width: 100%;">
            ...
            <article style="width: 33%; float: left; text-align: center;">
                <p style="font-size: 1.4rem; color: #445164;">মেয়াদোত্তীর্ণ স্টক রিপোর্ট</p>
            </article>
        ...
        <section style="margin-top: 1.6rem;">
            <p style="font-size: 1.2rem; color: #445164; margin-bottom: .4rem;">মেয়াদোত্তীর্ণ পণ্যের তালিকা (03)</p>

            <table style="width: 100%; padding: 0; border:none;">
                <tHead>
                    <tr>
                        <th style="width: 13rem;">পণ্যের নাম</th>
                        <th style="width:8rem;">মেয়াদোত্তীর্ণ স্টক পরিমান</th>
