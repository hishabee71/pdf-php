    ...
    <main
        ...
        <section style="width: 100%;">
            ...
            <article style="width: 33%; float: left; text-align: center;">
                <p style="font-size: 1.4rem; color: #445164;">All Customer Report</p>
        ...
        <section style="margin-top: 3rem;">
            <p style="font-size: 1.2rem; color: #445164; margin-bottom: .4rem;">Customer list: 2</p>

            <table style="width: 100%; padding: 0; border:none;">
                <tHead>
                    <tr>
                        <th style="width: 14rem;">Name & Mobile</th>
                        <th style="width: 11rem;">transaction (৳)</th>
                        <th style="width: 8rem;">advance</th>
                        <th style="width: 10.5rem;">i will get</th>
                        <th style="width: 10rem;">payment date</th>
                    </tr>
                </tHead>
